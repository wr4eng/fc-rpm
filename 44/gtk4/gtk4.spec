...
* Mon Jun 01 2026 W. Hadi HSW <wra.eng@gmail.com> - 4.23.1-1
- Update to 4.23.1

* Mon Apr 20 2026 Felipe Borges <felipeborges@gnome.org> - 4.23.0-1
- Update to 4.23.0

* Wed Apr 01 2026 Jan Grulich <jgrulich@redhat.com> - 4.22.2-2
- Packit: switch back to production instance

* Wed Apr 01 2026 Milan Crha <mcrha@redhat.com> - 4.22.2-1
- Update to 4.22.2

* Tue Mar 31 2026 Jan Grulich <jgrulich@redhat.com> - 4.22.1-5
- Packit: allow stage instance for testing

* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 4.22.1-4
- Add configuration for release-monitoring

* Wed Mar 25 2026 Milan Crha <mcrha@redhat.com> - 4.22.1-3
- Add a patch "gtkapplication-wayland: Add a missing NULL check when
  forgetting a window"
- Resolves: rhbz#2450986

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 4.22.1-1
- Update to 4.22.1

* Fri Mar 13 2026 Milan Crha <mcrha@redhat.com> - 4.22.0-1
- Update to 4.22.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 4.21.6-1
- Update to 4.21.6

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 4.21.5-6
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 4.21.5-5
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 4.21.5-4
- Onboard to Packit for stable Fedora branches

* Tue Feb 17 2026 Adam Williamson <awilliam@redhat.com> - 4.21.5-3
- Backport MR #9476 to fix GNOME Tour window height

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 4.21.5-1
- Update to 4.21.5

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 4.21.4-1
- Update to 4.21.4

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.21.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 30 2025 Matthias Clasen <mclasen@redhat.com> - 4.21.1-1
- Update to 4.21.1

* Tue Sep 30 2025 David King <amigadave@amigadave.com> - 4.21.0-1
- Update to 4.21.0
